...
class AhuWidget(tk.Frame, Observer):
    ...
    def update_widget(self):
        ...
        self.lbl_t_indoor_air.config(text=f"T° INDOOR {self.ahu.t_indoor_air} °C")
        self.lbl_t_outdoor_air.config(text=f"T° OUTDOOR {self.ahu.t_outdoor_air} °C")
        self.lbl_t_supply_air.config(text=f"T° SUPPLY {self.ahu.t_supply_air} °C")
        self.lbl_t_exhaust_air.config(text=f"T° EXHAUST {self.ahu.t_exhaust_air} °C")
